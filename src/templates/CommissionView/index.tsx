  ...
  return (
    <article className={"flex flex-col w-full" + ` ${className}`}>
      ...
      <small className="text-sm">
        <p>
          Any and all work made for a client is the sole intellectual property of the artist (Lydia Bullock).
          No reproduction or use can be used without the artists direct knowledge or consent.
          Under no circumstances may you download, reproduce, public or distribute elsewhere,
          in any medium, any of the images for commercial purposes, without proper and prior
